...
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { i_digitSelect[0] }]; #IO_L5N_T0_34               ,Sch=SW12
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { i_digitSelect[1] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { i_mode }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
